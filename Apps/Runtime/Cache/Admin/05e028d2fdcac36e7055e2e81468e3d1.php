...
<script type="text/javascript">
	var authUserUrl="<?php echo U('Auth/userList');?>";
    var authUserDelUrl="<?php echo U('Auth/userDel');?>";
    ...
    <div id="authUserAddDialog" class="easyui-dialog" style="width:400px;padding:10px 20px"
        ...
        <form id="authUserAddForm" method="post" novalidate>          
            <div class="fitem">
                <label>用&nbsp;&nbsp;户&nbsp;&nbsp;名</label>
                <input name="name" class="easyui-textbox" data-options="required:true,delay:1000,height:30,validType:['length[5,20]','exists[\'用户名\',\'<?php echo U('Auth/checkUser','','');?>\']']" />
            </div>
            <div class="fitem">
                <label>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</label>
            ...
            <div class="fitem">
                <label>邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱</label>
                <input name="email" id="authUserEmail" class="easyui-textbox" data-options="height:30,validType:['email','exists[\'邮箱\',\'<?php echo U('Auth/checkEmail','','');?>\']']" />
            </div>
            <div class="fitem">
                <label>积&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分</label>
            ...
            <div class="fitem">
                ...
                <select class="easyui-combobox" name="group" id='authUserGroup' data-options="height:30,required:true,editable:false">
                    <?php if(is_array($groupInfo)): $i = 0; $__LIST__ = $groupInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>"><?php echo ($vo['title']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>                         
                </select>   
            </div>     
        </form>
    </div>
    <div id="authUserAddButtons">
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="authUserObj.add('<?php echo U('Auth/userAdd');?>')" style="width:90px">添加</a>
    ...
    <div id="authUserEditDialog" class="easyui-dialog" style="width:400px;padding:10px 20px"
        ...
        <form id="authUserEditForm" method="post" novalidate>          
            ...
            <div class="fitem">
                <label>邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱</label>
                <input name="email" id="authUserEmail" class="easyui-textbox" data-options="height:30,validType:['email','exists[\'邮箱\',\'#authUserId\',\'<?php echo U('Auth/checkEmail','','');?>\']']" />
            </div>
            <div class="fitem">
                <label>积&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分</label>
                <input name="score" id="authUserScore" class="easyui-numberbox" data-options="height:30" />
    ...
    <div id="authUserEditButtons">
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="authUserObj.save('<?php echo U('Auth/userSave');?>')" style="width:90px">更新</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:
    ...
    <div id="authUserMoveButtons">
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="authUserObj.move('<?php echo U('Auth/userMove');?>')" style="width:90px">移动</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:
